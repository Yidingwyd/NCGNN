...
class SSNGNN(nn.Module):
    def __init__(self,
        ...
        # self.rn = ResidualNetwork(elem_fea_len, atom_fea_len, [128,64])
    ...
    def forward(self,
        ...
        # struct_node_fea = self.rn(struct_node_fea)
        # struct_node_fea = F.relu(struct_node_fea)
        # struct_node_fea = self.dropout(self.bn(struct_node_fea))
