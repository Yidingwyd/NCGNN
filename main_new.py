...
def main():
    ...
    sample_target = collate_fn(sample_data_list)[8]
    normalizer = Normalizer(sample_target)

    # build model
    comp_fea_len = train_dataset[0][1].shape[-1]
    bond_fea_len = train_dataset[0][4].shape[-1]
...
def train(train_loader, model, criterion, optimizer, epoch, normalizer):
    ...
    for i, batch_data in enumerate(train_loader):
        ...
        if args.cuda:
            ...
            comp_weights, comp_fea, self_fea_idx, comp_nbr_fea_idx, comp_node_idx,\
            ...
            input_var = (comp_weights, comp_fea, self_fea_idx, comp_nbr_fea_idx, comp_node_idx,\
